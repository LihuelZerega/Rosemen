...
function Features() {
  return (
    <div className="max-w-6xl mx-auto px-6 sm:px-6 lg:px-8 border-b-1">
      <section className="flex flex-col-reverse md:flex-row items-start justify-start mt-12 lg:mt-24">
        ...
        <div className="flex flex-col w-full md:w-1/2 lg:max-w-md md:pl-4 lg:p-4">
          ...
          <p className="text-center sm:text-left">
            Investigamos, planificamos, e implementamos estrategias para obtener
      ...
      <section className="flex flex-col-reverse lg:flex-row-reverse lg:justify-between mt-12 lg:mt-24">
        ...
        <div className="flex flex-col w-full lg:w-1/2 lg:max-w-md p-4">
          ...
          <p className="text-[#720D1C] font-medium hover:font-semibold hover:text-red-900 mt-4 cursor-pointer">
            Ver mas →
          </p>
        </div>
      </section>
