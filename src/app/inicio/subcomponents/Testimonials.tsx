...
function Testimonials() {
  return (
    <section className="py-10 bg-white sm:pb-16 lg:pb-24">
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-2xl lg:text-3xl font-semibold text-gray-900">
            <span className=""> ¿Que opinan nuestros clientes? </span>
          </h2>
          <p className="mt-2">Descubrí la opinión de quienes han confiado en nosotros</p>
        </div>
