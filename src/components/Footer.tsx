...
import RosemenLogo from "@/images/Logos/rosemen-512-Negro-sin-fondo.png";
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            ...
            <div className="lg:col-span-2">
              <p className="text-base font-semibold text-gray-900">Servicios</p>

              <ul className="mt-6 space-y-5">
                <li>
                  <a
                    href="/servicios#viapublica"
                    title=""
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="mt-6 space-y-5">
                ...
                <li>
                  <a
                    href="/contacto#horariosdeatencion"
                    title=""
                    className="flex text-sm text-gray-800 transition-all duration-200 hover:text-[#720D1C] focus:text-[#720D1C]"
                  >
                    {" "}
            ...
            <ul className="flex items-center mt-5 space-x-3 md:order-3 sm:mt-0">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full w-7 h-7 focus:bg-[#720D1C] hover:text-white focus:text-white hover:bg-[#720D1C] hover:border-[#720D1C] focus:border-[#720D1C]"
                >
                  <svg
                    className="w-4 h-4"
